    ...
    <div className="min-h-screen bg-slate-50">
      <header className="bg-white border-b border-slate-200 px-6 h-14 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs bg-green-50 text-green-700 px-2 py-0.5 rounded-full font-medium">Panel Profesor</span>
        </div>
        <div className="flex items-center gap-4">
          <span className="text-sm text-slate-600">Prof. <strong>{usuario?.nombre} {usuario?.apellido}</strong></span>
